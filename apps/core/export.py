...
# X-Seti - November16 2025 - IMG Factory 1.5 - Export Functions
...
def export_selected_function(main_window) -> bool: #vers 1
...
def export_all_function(main_window) -> bool: #vers 1
