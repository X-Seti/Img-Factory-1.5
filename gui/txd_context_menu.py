...
# This belongs in gui/ txd_context_menu.py - Version: 1
"""
...
def create_txd_context_menu(workshop, position): #vers 1
    """
    ...
    # TEXTURE OPERATIONS
    menu.addSeparator()
    texture_menu = menu.addMenu("🖼️ Texture")
    
    import_action = texture_menu.addAction("Import Texture...")
    import_action.triggered.connect(workshop.import_texture)
    ...
    rename_action.triggered.connect(lambda: workshop._rename_texture(False))
    ...
    # FORMAT & COMPRESSION
    menu.addSeparator()
    format_menu = menu.addMenu("⚙️ Format")
    ...
    create_mipmaps_action.triggered.connect(workshop._create_mipmaps)
    ...
    show_mipmaps_action.triggered.connect(workshop._show_mipmap_levels)
    ...
    if has_selection and hasattr(workshop, '_has_bumpmap_data'):
        ...
        menu.addSeparator()
        bumpmap_menu = menu.addMenu("🗺️ Bumpmap")
    ...
    stats_action.triggered.connect(workshop._show_txd_statistics)
    ...
    # SETTINGS
    menu.addSeparator()
    settings_action = menu.addAction("⚙️ Workshop Settings")
