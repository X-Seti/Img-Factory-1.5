...
class IMGFactoryGUILayout:
    ...
    def create_main_ui_with_splitters(self, main_layout):
        ...
        # Set splitter proportions (76% left, 24% right) - made right panel 14% narrower
        self.main_splitter.setSizes([912, 258])  # Was 840,250 - now narrower right panel
    ...
    def _create_right_panel_with_pastel_buttons(self):
        ...
        img_box = QGroupBox("IMG, COL and TXD Files")
