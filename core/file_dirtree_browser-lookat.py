...
class FileBrowserWidget(QWidget):
    ...
    def create_info_panel(self): #vers 1
        ...
        self.open_btn.setMinimumHeight(30)  # 10px adjustment
        self.open_btn.clicked.connect(self.open_selected)
        actions_layout.addWidget(self.open_btn, 0, 0)
        
        self.edit_btn = QPushButton("✏️ Edit")
        self.edit_btn.setEnabled(False)
        self.edit_btn.setMinimumHeight(30)  # 10px adjustment
        ...
        self.copy_btn.setMinimumHeight(30)  # 10px adjustment
        self.copy_btn.clicked.connect(self.copy_files)
        actions_layout.addWidget(self.copy_btn, 1, 0)
        
        self.delete_btn = QPushButton("🗑️ Delete")
        self.delete_btn.setEnabled(False)
        self.delete_btn.setMinimumHeight(30)  # 10px adjustment
