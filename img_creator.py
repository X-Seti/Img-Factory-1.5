...
class GameType:
    ...
    GTA3 = {
        'name': 'GTA III',
        'code': 'gta3',
        'img_version': IMGVersion.IMG_1,  # Fixed: Using correct enum value
    ...
    GTASA = {
        ...
        'code': 'gtasa',
        'img_version': IMGVersion.IMG_2,  # Fixed: Using correct enum value
        'platform': Platform.PC,
        'default_size': 150,
        'supports_compression': False,
        'supports_encryption': False,
    ...
    GTAIV = {
        'name': 'GTA IV',
        'code': 'gtaiv',
        'img_version': IMGVersion.IMG_3,  # Fixed: Using correct enum value
        'platform': Platform.PC,
        'default_size': 200,
    ...
    GTASTORIES = {
        'name': 'GTA Stories',
        'code': 'gtastories',
        'img_version': IMGVersion.IMG_STORIES,  # Fixed: Using correct enum value
    ...
    FASTMAN92 = {
        ...
        'code': 'fastman92',
        'img_version': IMGVersion.IMG_FASTMAN92,  # Fixed: Using correct enum value
        'platform': Platform.PC,
        'default_size': 500,
        'supports_compression': True,
        'supports_encryption': False,
...
if __name__ == "__main__":
    test_new_img_dialog()#this belongs in components/ /img_creator.py
#!/usr/bin/env python3
"""
X-Seti - June25,2025 - IMG Factory 1.5 - IMG Creator
Enhanced IMG Creator dialog for creating new IMG files
